...
@Component({
    selector: 'sidebar-nav2',
    templateUrl: './sidebar-nav2.component.html',
    styleUrls: ['./sidebar-nav2.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    preserveWhitespaces: false
})
export class SidebarNav2Component implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.change$ = <any>this.menuSrv.change.subscribe((res: any) => {
            this.list = res;
