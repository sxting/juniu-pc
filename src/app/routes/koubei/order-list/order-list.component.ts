...
export class OrderListComponent implements OnInit {
  ...
  // 条件查询
  getData() {
    if (this.switchOrderListBtns) {
      //查看订单页面
      this.productOrderListInfor();
    } else if (this.switchHexiaoListBtns) {
      //查看核销页面
