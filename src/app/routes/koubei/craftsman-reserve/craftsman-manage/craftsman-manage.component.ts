...
export class CraftsmanManageComponent implements OnInit {
    ...
    //职业列表
    careersList: any[] = [
      '发型师','美甲师','美容师','美睫师','纹绣师', '纹身师','摄影师','教练','教师','化妆师','司仪', '摄像师','按摩技师','足疗技师','针灸师','理疗师','修脚师','采耳师','其他'
    ];
    ...
    formInit() {
        if(this.staffId) {
            ...
            this.form = this.fb.group({
                ...
                phone_form: ['', [Validators.compose([Validators.required, Validators.pattern(`^[1][3,4,5,6,7,8,9][0-9]{9}$`)])]],
